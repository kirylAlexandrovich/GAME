export function enemyMove() {
  ...
  let trollMove = setInterval(() => {
    ...
    const troll = enemyCanvas.getContext('2d');
...
const eAttack = document.getElementById('enemyAttack');
eAttack.addEventListener('click', trollAttack);
const enemyDie = document.getElementById('enemyDie');
enemyDie.addEventListener('click', trollDie);
